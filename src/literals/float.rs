...
mod tests {
    ...
    parser_helper!(fn parse_float_helper -> f32, pair: Rule::float, Rule::float => parse_float(pair));

    #[test]
    fn test_float () {
        assert_eq!(parse_float_helper("3."), 3.);
        assert_eq!(parse_float_helper("0.3"), 0.3);
        assert_eq!(parse_float_helper("3.0E-5"), 3.0E-5);
        assert_eq!(parse_float_helper("3.0e10"), 3.0e10);
    }
    ...
    fn test_float_fail_signed_int () {
        assert_eq!(parse_float_helper("-."), 0.)
    }
    ...
    fn test_float_fail_binary_notation () {
        assert_eq!(parse_float_helper("0b101010e10"), 3.0e10);
    }
}
